...
%   backmatter/ 声明、参考文献与附录
%                declaration.tex  AI 工具使用声明
%                references.tex   参考文献
%                appendix.tex     支撑材料清单、软件环境、图表对应关系与核心程序
...
\mcmkeywords{储能调度；线性规划；分位数风险裕量；滚动合同调整；跨日优化}
...
\input{sections/05-problem2-model}
\input{sections/06-problem2-results}
\input{sections/07-problem3}
\input{sections/08-problem4}
